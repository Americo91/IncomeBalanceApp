...
public class MonthBalance extends AbstractBalanceEntity {
    ...
    @Builder
    public MonthBalance(Long id, BigDecimal salary, BigDecimal expenses, BigDecimal incomes, BigDecimal result, String month, List<BankBalance> bankBalanceList) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(month, that.month) && Objects.equals(bankBalanceList, that.bankBalanceList);
    }

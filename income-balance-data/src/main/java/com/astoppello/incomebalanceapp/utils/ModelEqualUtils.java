...
public class ModelEqualUtils {
    ...
    public static void assertYearBalanceAndYearBalanceDtoAreEquals(YearBalance yearBalance, YearBalanceDTO yearBalanceDTO) {
    ...
    public static void assertMonthBalanceAndDtoAreEqual(MonthBalance monthBalance, MonthBalanceDTO monthBalanceDTO) {
        ...
        for (int i = 0; i < monthBalance.getBankBalanceList().size(); i++) {
            assertBankBalanceAndDtoAreEqual(monthBalance.getBankBalanceList()
                                                        .get(i), monthBalanceDTO.getBankBalanceDTOList().get(i));
        }
    }
}

...
import com.astoppello.incomebalanceapp.mappers.BankMapperTest;
...
import static com.astoppello.incomebalanceapp.mappers.BankMapperTest.ID;
import static com.astoppello.incomebalanceapp.mappers.BankMapperTest.NAME;
...
class BankServiceTest {
  ...
  void setUp() {
    ...
    bank = Bank.builder().id(ID).name(NAME).build();
  }
